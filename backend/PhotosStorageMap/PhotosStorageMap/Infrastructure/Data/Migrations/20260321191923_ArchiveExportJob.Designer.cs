...
namespace PhotosStorageMap.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260321191923_ArchiveExportJob")]
    partial class ArchiveExportJob
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PhotosStorageMap.Domain.Entities.ArchiveExportJob", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("CollectionId", "Type", "Status");

                    b.ToTable("ArchiveExportJobs");
                });
            ...
            modelBuilder.Entity("PhotosStorageMap.Domain.Entities.ArchiveExportJob", b =>
                {
                    b.HasOne("PhotosStorageMap.Domain.Entities.UploadCollection", "Collection")
                        .WithMany()
