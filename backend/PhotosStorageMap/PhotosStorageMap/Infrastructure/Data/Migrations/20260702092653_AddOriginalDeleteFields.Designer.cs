...
namespace PhotosStorageMap.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260702092653_AddOriginalDeleteFields")]
    partial class AddOriginalDeleteFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PhotosStorageMap.Domain.Entities.ArchiveItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("UploadCollectionId", "CreatedAtUtc");
            ...
            modelBuilder.Entity("PhotosStorageMap.Domain.Entities.PhotoItem", b =>
                {
                    ...
                    b.Property<string>("OriginalDeleteError")
                        .HasColumnType("text");

                    b.Property<bool>("OriginalDeleteRequested")
                        .HasMaxLength(2000)
                        .HasColumnType("boolean");

                    b.Property<DateTime?>("OriginalDeleteRequestedAtUtc")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTime?>("OriginalDeletedAtUtc")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.HasIndex("OriginalDeleteRequested", "OriginalDeleteRequestedAtUtc");
            ...
            modelBuilder.Entity("PhotosStorageMap.Domain.Entities.ShareLink", b =>
                {
                    ...
                    b.Property<bool>("AllowDownloadOriginalFromCard")
                        .HasColumnType("boolean");

                    b.Property<bool>("AllowDownloadResizedZip")
                        .HasColumnType("boolean");

                    b.Property<bool>("AllowSlideshowOriginals")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("PhotosStorageMap.Domain.Entities.UploadCollection", b =>
                {
                    ...
                    b.Property<long>("ArchiveDownloadBytes")
                        .HasColumnType("bigint");

                    b.Property<int>("ArchiveDownloadCount")
                        .HasColumnType("integer");

                    b.Property<long>("ArchiveUploadBytes")
                        .HasColumnType("bigint");

                    b.Property<int>("ArchiveUploadCount")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("TotalArchives")
                        .HasColumnType("integer");

                    b.Property<long>("TotalArchivesBytes")
                        .HasColumnType("bigint");
